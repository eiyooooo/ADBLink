...
public class LocalServices {
    ...
    static String getServiceName(@Services int service) {
        return switch (service) {
            case SHELL -> "shell:";
            case CONNECT_JDWP -> "jdwp:";
            case FILE -> "dev:";
            case FRAMEBUFFER -> "framebuffer:";
            case LOCAL_UNIX_SOCKET -> "local:";
            case LOCAL_UNIX_SOCKET_ABSTRACT -> "localabstract:";
            case LOCAL_UNIX_SOCKET_FILE_SYSTEM -> "localfilesystem:";
            case LOCAL_UNIX_SOCKET_RESERVED -> "localreserved:";
            case REMOUNT -> "remount:";
            case REVERSE -> "reverse:";
            case SYNC -> "sync:";
            case TCP_CONNECT -> "tcp:";
            case TRACK_JDWP -> "track-jdwp";
            case BACKUP -> "backup:";
            case RESTORE -> "restore:";
            default -> throw new IllegalArgumentException("Invalid service: " + service);
        };
    }
